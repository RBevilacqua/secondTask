...
class ViewController: UIViewController,UIPickerViewDataSource,UIPickerViewDelegate {
    ...
    var pickerData = [
        ...
        ["id":10,"name":"Foreign Languages"],
        ["id":11,"name":"Geology"],
        ["id":12,"name":"Health & Medical"],
        ["id":13,"name":"History"],
        ["id":14,"name":"Law"],
        ...
        ["id":22,"name":"Science"],
        ["id":23,"name":"Social Science"],
        ["id":24,"name":"Sociology"],
        ["id":25,"name":"Statistics"],
        ["id":26,"name":"Writing"],
        ["id":27,"name":"Other"],
        ["id":28,"name":"Algebra"],
        ["id":29,"name":"Programming"],
        ["id":30,"name":"Communications"],
        ["id":31,"name":"Film"],
        ["id":32,"name":"Management"],
        ["id":33,"name":"SAT"]
    ]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        println(pickerData[0])
